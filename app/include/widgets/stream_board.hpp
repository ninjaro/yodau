#ifndef YODAU_FRONTEND_WIDGETS_STREAM_BOARD_HPP
#define YODAU_FRONTEND_WIDGETS_STREAM_BOARD_HPP
...
class stream_board final : public QWidget {
    Q_OBJECT
public:
...
#endif // YODAU_FRONTEND_WIDGETS_STREAM_BOARD_HPP
