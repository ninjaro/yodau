#ifndef YODAU_APP_SHELL_STREAM_ROUTE_STATE_HPP
#define YODAU_APP_SHELL_STREAM_ROUTE_STATE_HPP
...
public:
    ...
    static QString
    source_description(const QString& source, const QString& type);

    [[nodiscard]] bool has_active_stream() const;
    [[nodiscard]] const QString& active_stream_name() const;
    [[nodiscard]] bool is_active_stream(const QString& stream_name) const;

    void set_active_stream(const QString& stream_name);
    void clear_active_stream();
    bool hide_stream(const QString& stream_name);
    [[nodiscard]] QString
    next_active_stream_for_enlarge(const QString& stream_name) const;
...
#endif // YODAU_APP_SHELL_STREAM_ROUTE_STATE_HPP
