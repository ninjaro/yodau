...
int main(int argc, char** argv) {
    ...
    try {
        ...
        static_cast<void>(monitor::start_process("yodau-daemon"));
        monitor::set_channel_active(monitor::channel::main, true);
        ...
        monitor::set_channel_active(monitor::channel::main, false);
        return result;
