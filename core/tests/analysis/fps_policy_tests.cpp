...
TEST(fps_policy_test, playback_only_disables_analysis_budgeting) {
    const yodau::core::fps_capability_profile capability {
        .hardware_threads = 8,
        .tier = yodau::core::fps_capability_tier::balanced,
    };
    const yodau::core::fps_runtime_factors factors {
        .mode = yodau::core::fps_mode::playback_only,
    ...
    const auto profile
        = yodau::core::recommend_fps_profile(capability, factors);
...
TEST(fps_policy_test, active_stream_keeps_higher_fps_and_quality) {
    ...
    const yodau::core::fps_runtime_factors grid_factors {
    ...
    active_factors.role = yodau::core::fps_stream_role::active;

    const auto grid_profile
        = yodau::core::recommend_fps_profile(capability, grid_factors);
    const auto active_profile
        = yodau::core::recommend_fps_profile(capability, active_factors);
...
TEST(fps_policy_test, heavier_runtime_pressure_reduces_budget) {
    ...
    const yodau::core::fps_runtime_factors light_factors {
        .mode = yodau::core::fps_mode::playback_and_processing,
        .role = yodau::core::fps_stream_role::grid,
    ...
    const yodau::core::fps_runtime_factors heavy_factors {
        .mode = yodau::core::fps_mode::playback_and_processing,
        .role = yodau::core::fps_stream_role::grid,
    ...
    const auto light_profile
        = yodau::core::recommend_fps_profile(capability, light_factors);
    const auto heavy_profile
        = yodau::core::recommend_fps_profile(capability, heavy_factors);
