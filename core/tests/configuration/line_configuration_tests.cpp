...
TEST(line_configuration_test, current_document_round_trips_every_setting) {
    const auto expected = sample_configuration();
    const std::string encoded
        = yodau::core::encode_line_configuration_json(expected);
    const auto decoded = yodau::core::decode_line_configuration_json(encoded);
...
TEST(line_configuration_test, explicit_json_codec_round_trips) {
    const auto expected = sample_configuration();
    const std::string encoded
        = yodau::core::encode_line_configuration_json(expected);
    EXPECT_EQ(yodau::core::decode_line_configuration_json(encoded), expected);
}
...
TEST(line_configuration_test, rejects_unknown_fields_and_invalid_geometry) {
    ...
    EXPECT_THROW(
        static_cast<void>(
            yodau::core::decode_line_configuration_json(unknown_field)
        ),
    ...
    EXPECT_THROW(
        static_cast<void>(yodau::core::encode_line_configuration_json(invalid)),
        yodau::core::line_configuration_error
    );
}
...
TEST(line_configuration_test, atomic_file_round_trip_uses_shared_loader) {
    ...
    yodau::core::save_line_configuration_file_atomic(expected, path);
    EXPECT_EQ(yodau::core::load_line_configuration_file(path), expected);
...
TEST(line_configuration_test, rejects_noncanonical_names_and_unsafe_profiles) {
    ...
    EXPECT_THROW(
        static_cast<void>(
            yodau::core::encode_line_configuration_json(invalid_name)
        ),
        yodau::core::line_configuration_error
    );
    ...
    EXPECT_THROW(
        static_cast<void>(
            yodau::core::encode_line_configuration_json(invalid_profile)
        ),
        yodau::core::line_configuration_error
    );
}
...
TEST(line_configuration_test, failed_atomic_save_preserves_existing_file) {
    ...
    EXPECT_THROW(
        yodau::core::save_line_configuration_file_atomic(invalid, path),
        yodau::core::line_configuration_error
    );
